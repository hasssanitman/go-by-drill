...
func main() {
	...
	// types. It will only include exported fields in the encoded output
	...
	// encoded JSON key names. Check the definition of response2
	...
	// advantages of adding additional type-safety to our programs and
	// eliminating the need for type assertions when accessing the
	// decoded data.
