...
// iteration over basic data structures. We can also use this syntax
...
// $ go run range_over_channels/range_over_channels.go
// one
// two

// This example also showed that it’s possible to close a non-
// empty channel but still have the remaining values be received.
