...
func main() {
	...
	// type of elements and length are both part of the array’s type. By
	// default an array is zero-valued, which for ints means 0s.
	var a [5]int
	fmt.Println("Empty 5 length array: ", a)
...
// Empty 5 length array:  [0 0 0 0 0]
// set:  [0 0 0 0 400]
// get:  400
// array's len:  5
// dcl:  [10 20 30 40 50]
