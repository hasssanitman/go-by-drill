// Go has several useful functions for working with directories in
// the file system.
...
func main() {
	...
	// defer their removal. os.RemoveAll will delete a whole
	...
	// Chdir lets us change the current working directory, similarly to
	// cd.
	...
	// We can also visit a directory recursively, including all its sub-
	// directories. Walk accepts a callback function to handle every file
	// or directory visited.
...
// $ go run directories/directories.go
