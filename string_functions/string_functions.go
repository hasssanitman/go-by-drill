...
// string-related functions. Here are some examples to give you a
...
// We alias fmt.Println to a shorter name as we’ll use it a lot
// below.
var p = fmt.Println
...
func main() {
	...
	// object itself, we need pass the string in question as the first
	// argument to the function. You can find more functions in the
	// strings package docs.
...
// $ go run string_functions/string_functions.go
// Contains:  true
// Count:  2
// HasPrefix:  true
// HasSuffix:  true
