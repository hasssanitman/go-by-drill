...
func main() {
	...
	// key, use os.Getenv. This will return an empty string if the key isn’t
	...
	// strings.SplitN them to get the key and value. Here we print
	// all the keys.
	fmt.Println()
...
// picks that value up.
// $ BAR=2 go run environment_variables/environment_variables.go
// FOO: 1
// BAR: 2
// ...
