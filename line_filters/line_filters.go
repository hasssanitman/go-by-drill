...
func main() {
	...
	// gives us a convenient Scan method that advances the scanner to
	// the next token; which is the next line in the default scanner.
	scanner := bufio.NewScanner(os.Stdin)

	// Text returns the current token, here the next line, from the
	// input.
	for scanner.Scan() {
...
// To try out our line filter, first make a file with a few lowercase
// lines.
// $ echo 'hello'   > /tmp/lines
// $ echo 'filter' >> /tmp/lines

// Then use the line filter to get uppercase lines.
// $ cat /tmp/lines | go run line_filters/line_filters.go
// HELLO
// FILTER
