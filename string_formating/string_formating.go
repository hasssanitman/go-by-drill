...
// tradition. Here are some examples of common string formatting
// tasks.
...
func main() {
	...
	// width and precision of the resulting figure. To specify the width
	// of an integer, use a number after the % in the verb. By default the
	...
	// especially to ensure that they align in table-like output. For basic
	...
	// os.Stdout. Sprintf formats and returns a string without
...
// $ go run string_formating/string_formating.go
// struct1: {1 2}
// struct2: {x:1 y:2}
