// URLs provide a uniform way to locate resources. Here’s how to
// parse URLs in Go.
...
func main() {
	...
	// authentication info, host, port, path, query params, and query
	// fragment.
	...
	// param maps are from strings to slices of strings, so index into
...
// $ go run url_parsing/url_parsing.go
// postgres
// user:pass
// user
// pass
