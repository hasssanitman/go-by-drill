...
// identifiers from this package, you can do a blank import with _
// "embed".
import (
	"embed"
)
...
// wildcards. This uses a variable of the embed.FS type, which
...
// limitation on go playground, this example can only be run on
// your local machine.)

// $ go run embed_direrctive.go
// hello go
// hello go
// 123
// 456
