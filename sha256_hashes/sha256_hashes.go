...
// Go implements several hash functions in various crypto/*
// packages.
import (
	"crypto/sha256"
	"fmt"
...
// $ go run sha256_hashes/sha256_hashes.go
// sha256 this string
...
// shown above. For example, to compute SHA512 hashes import
// crypto/sha512 and use sha512.New().
