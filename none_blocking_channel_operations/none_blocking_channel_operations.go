...
// can use select with a default clause to implement non-
// blocking sends, receives, and even non-blocking multi-way
// selects.
...
// $ go run none_blocking_channel_operations/none_blocking_channel_operations.go
// no message received
// no message sent
// no activity
