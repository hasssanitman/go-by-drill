...
// the methods in the interface. Here we implement geometry on
// rects.
...
// are in the named interface. Here’s a generic measure function
...
func main() {
	...
	// geometry interface so we can use instances of these structs as
